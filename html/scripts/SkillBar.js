...
function CheckSkillBar() {
  var CurrentWidth =
    ($("#SkillBar").width() / $("#SkillbarBase").width()) * 100;
  var Max = skillbar_left + skillbar_width + 5;
  console.log(
    `With: ${CurrentWidth} | Green Left: ${skillbar_left} | Green Max: ${Max}`
  );
